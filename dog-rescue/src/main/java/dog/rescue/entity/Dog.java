...
//Delete row from different tables - PERSIST
//TOSTRING will create string for all fields in location and dog classes except for fields location aond breeds in dog class